...
- `winding-jig-range.png`: Kopf bei Ø110 / Ø127 / Ø145 mm, sechs Rippen,
  18 nummerierte Bandstellen und Wickeldrehsinn.
...
13 verschiedene STL-Dateien ergeben 24 Druckteile. Die Dateistämme sind unten
...
- Rahmen- und Abrollerbasis mit ihrer breiten Unterseite auf das Bett.
...
- Rückplatte, Kurvenring, Klemmring, Rippen, Schieber, Nabe, Haltering und Kurbel
...
| 3 | `M3 x 10 mm socket-head cap screw` | ISO 4762 M3 x 10, 5.5 mm head diameter, 3 mm head height |
| 4 | `M4 upright bolt` | M4 x 25 mm through-bolt |
| 4 | `M4 upright nut` | M4 locking nut |
| 8 | `M4 upright washer` | M4 flat washer |
...
| 1 | `head collar retaining pin` | 4 mm diameter x 22 mm removable cross-pin |
...
| 4 | `wire_payoff bench bolt` | M5 through-bolt; length = bench thickness + 18 mm |
...
4. Drei M3-Vorspannmuttern radial in den Haltering einsetzen, dann die drei
   M3×10-Schrauben lose einsetzen. Nabe mit drei formschlüssigen Mitnehmern,
   Kopf und Haltering auf der 8-mm-Welle montieren; zugehörige Querbolzen
   und Sicherungsclips einsetzen. Nabenmitnehmer müssen vollständig in der
   Rückplatte sitzen. Kein Drehmoment allein über eine Druckpassung übertragen.
5. Beide 608 in ihre Ständer setzen. Welle mit Kopf zwischen die Ständer
   einsetzen und durch beide Innenringe führen. Ständer mit vier M4×25,
   vier Sicherungsmuttern und acht Scheiben an der Basis befestigen.
   Fluchtung prüfen; Lager dürfen nicht verspannt oder mit Kraft überbrückt werden.
...
2. M3-Mutter in das seitliche Fenster des gedruckten Einstellers einsetzen.
   ...
   durch den seitlichen Servicezugang einsetzen.
...
Die zusammengehaltene runde Spule abnehmen und ohne scharfe Knicke an den
