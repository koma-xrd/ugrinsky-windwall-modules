...
def _joint_paths(a: RotorAssembly) -> dict:
    ...
    for lower_name, upper_name in (('base', 'standard'), ('standard', 'standard'), ('standard', 'top')):
        ...
        # Plain blade ends meet only after the final phase is reached. Added
        # receiver headroom clears the rigid lug roof; snap-pawl contact
...
def audit_rotor_assembly(a: RotorAssembly) -> dict:
    ...
    return {'stage_count': a.aerodynamic_stage_count, 'base_count': a.base_count,
            ...
            'axial_float_note': 'Plain blade ends meet at nominal pitch; compression probes do not establish physical load capacity',
            ...
            'contact_semantics': ('Named 51105 washer/support contacts; permanent bayonet stops; '
